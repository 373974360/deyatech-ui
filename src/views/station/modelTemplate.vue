    ...
    <basic-container>
        <div class="deyatech-container pull-auto">
            ...
            <el-table :data="modelTemplateList" v-loading.body="listLoading" stripe border highlight-current-row
                ...
                <el-table-column align="center" label="默认标记" prop="defaultFlag"/>
            ...
            <el-dialog :title="titleMap[dialogTitle]" :visible.sync="dialogVisible"
                ...
                <span slot="footer" class="dialog-footer">
                    ...
                    <el-button :size="btnSize" @click="closeModelTemplateDialog">{{$t('table.cancel')}}</el-button>
                </span>
            </el-dialog>
        </div>
    </basic-container>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                modelTemplateRules: {
                    ...
                    templatePath: [
                        {required: true, message: this.$t("table.pleaseInput") + '模版路径'}
                    ],
                    contentModelId: [
        ...
        computed: {
            ...
            btnEnable() {
                return {
                    create: this.permission.modelTemplate_create,
                    update: this.permission.modelTemplate_update,
                    delete: this.permission.modelTemplate_delete
                };
            }
        },
        created(){
        ...
        methods: {
            ...
            btnUpdate(row){
                this.resetModelTemplate();
                if (row.id) {
                    this.modelTemplate = deepClone(row);
                } else {
                    this.modelTemplate = deepClone(this.selectedRows[0]);
                }
            ...
            doCreate(){
                this.$refs['modelTemplateDialogForm'].validate(valid => {
                    if(valid) {
                        ...
                        createOrUpdateModelTemplate(this.modelTemplate).then(() => {
