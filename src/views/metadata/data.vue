        ...
        <!--<div class="deyatech-container pull-auto">-->
            ...
            <!--<div class="deyatech-menu">-->
                ...
                <!--<div class="deyatech-menu_right">-->
                    <!--&lt;!&ndash;<el-button type="primary" icon="el-icon-edit" :size="btnSize" circle @click="btnUpdate"></el-button>-->
                    <!--<el-button type="danger" icon="el-icon-delete" :size="btnSize" circle @click="btnDelete"></el-button>&ndash;&gt;-->
            ...
            <!--<div class="standard-text">-->
                ...
                <!--<el-table class="table-list" :data="templateList" v-loading.body="listLoading" stripe border highlight-current-row-->
                    ...
                    <!--&lt;!&ndash;template表数据&ndash;&gt;-->
                    <!--<el-table-column type="selection" width="50" align="center"/>-->
                    <!--<el-table-column align="center" label="标题" prop="title"/>-->
                    <!--<el-table-column align="center" label="元数据集" prop="contentModelName"/>-->
                    <!--<el-table-column align="center" label="作者姓名" prop="author"/>-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="URL" prop="url">-->
                        ...
                        <!--</template>-->
                    <!--</el-table-column>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="排序号" prop="sortNo"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="是否置顶" prop="flagTop">&ndash;&gt;-->
                        <!--&lt;!&ndash;<template slot-scope="scope">&ndash;&gt;-->
                            <!--&lt;!&ndash;{{scope.row.flagTop ? '是' : '否'}}&ndash;&gt;-->
                        <!--&lt;!&ndash;</template>&ndash;&gt;-->
                    <!--&lt;!&ndash;</el-table-column>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="站点id" prop="siteId"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="模板路径" prop="templatePath"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="栏目ID" prop="cmsCatalogId"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="内容模型ID" prop="contentModelId"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="内容唯一ID" prop="contentId"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="状态" prop="status"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="内容模型模板ID" prop="contentModelTemplateId"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="编辑姓名" prop="editor"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="来源" prop="source"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="缩略图" prop="thumbnail"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="是否允许搜索到" prop="flagSearch"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="浏览次数" prop="views"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column align="center" label="是否是外链" prop="flagExternal"/>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-table-column prop="enable" :label="$t('table.enable')" align="center" width="90">-->
                        <!--<template slot-scope="scope">-->
            ...
            <!--<el-dialog :title="titleMap[dialogTitle]" :visible.sync="dialogVisible"-->
                ...
                <!--<el-form ref="templateDialogForm" class="deyatech-form" :model="template" label-position="right"-->
                    ...
                    <!--<el-row :gutter="20" :span="24">-->
                        <!--<el-col :span="12">-->
                            <!--<el-form-item label="资源分类" prop="resourceCategory"> &lt;!&ndash;TODO&ndash;&gt;-->
                    ...
                    <!--&lt;!&ndash; 选择内容模型后，元数据等相关 TODO &ndash;&gt;-->
                    <!--<el-form-item-->
                        ...
                        <!--&lt;!&ndash; 输入框 &ndash;&gt;-->
                        <!--<el-input v-if="item.controlType === 'inputElement'" v-model="template.content[item.fieldName]">-->
                        <!--</el-input>-->
                        <!--&lt;!&ndash; 选择器 &ndash;&gt;-->
                        <!--<el-select v-if="item.controlType === 'selectElement'&& contentItemOptions[item.id]"-->
                                   <!--v-model="template.content[item.fieldName]" placeholder="请选择">-->
                            <!--<el-option v-for="opt in contentItemOptions[item.id]" :key="opt.id" :label="opt.codeText"-->
                                       <!--:value="opt.id">-->
                            <!--</el-option>-->
                        <!--</el-select>-->
                        <!--&lt;!&ndash; 单选框 &ndash;&gt;-->
                        <!--<el-radio-group v-if="item.controlType === 'radioElement' && contentItemOptions[item.id]"-->
                        ...
                        <!--</el-radio-group>-->
                        <!--&lt;!&ndash; 多选框 &ndash;&gt;-->
                        <!--<el-checkbox-group v-if="item.controlType === 'checkboxElement' && contentItemOptions[item.id]"-->
                                           <!--v-model="contentItemArray[item.fieldName]">-->
                        ...
                        <!--<editor v-if="item.controlType === 'richTextElement'" :ref="item.id" :id="'editor' + index"-->
                                <!--:default-msg="editorDefaultMsg[item.id]" :config="editorConfig">-->
                        <!--</editor>-->
                        <!--&lt;!&ndash; 时间类型 &ndash;&gt;-->
                        <!--<template v-if="item.metadata.dataType === 'date'">-->
                            ...
                            <!--<el-date-picker v-else-if="item.controlType === 'datetimeElement'"-->
                                            <!--v-model="template.content[item.fieldName]"-->
                                            <!--type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择时间">-->
                            <!--</el-date-picker>-->
