    ...
    <basic-container>
        <div class="deyatech-container pull-auto">
            ...
            <el-table :data="configList" v-loading.body="listLoading" stripe border highlight-current-row
                ...
                <el-table-column align="center" label="评价等级" prop="level" width="230">
...
<!--                <el-table-column align="center" label="评价等级描述（非常满意、满意等）" prop="description"/>-->
                ...
                <el-table-column align="center" label="组织机构代码" prop="organizationalCode" width="130"/>
            ...
            <el-dialog :title="titleMap[dialogTitle]" :visible.sync="dialogVisible"
                ...
                <el-form ref="configDialogForm" class="deyatech-form" :model="config" label-position="right"
                    ...
                    <el-row :gutter="20" :span="24">
                        <!--<el-col :span="12">
                            <el-form-item label="评价等级（1，2，3，4，5分别代表非常不满意、不满意等）" prop="level">
                                <el-input v-model="config.level"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="评价等级描述（非常满意、满意等）" prop="description">
                                <el-input v-model="config.description"></el-input>
                            </el-form-item>
                        </el-col>-->
                        <el-col :span="24">
                    ...
                    <el-row :gutter="20" :span="24">
                        <el-col :span="12">
                            <el-form-item label="测评指标编码" prop="contentCode">
                                <el-input v-model="config.contentCode"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20" :span="24">
                        <el-col :span="24">
                            <el-form-item label="测评指标内容" prop="content">
                                <el-input type="textarea" v-model="config.content" :rows="3"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20" :span="24">
...
<script>
    ...
    export default {
        ...
        created(){
            this.evaluateEnum = this.loadEnum('EvaluateEnum');
            this.reloadList();
        },
        methods: {
            loadEnum(name) {
            ...
            btnCreate(){
                this.resetConfig();
                this.config.organizationalCode = '123456';
            ...
            levelChange(value) {
                for (let e of this.evaluateEnum) {
                    if (value == e.code) {
