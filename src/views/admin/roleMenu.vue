<template>
    <basic-container>
        <div class="deyatech-container pull-auto">
            ...
            <el-table :data="roleMenuList" v-loading.body="listLoading" stripe border highlight-current-row
                    ...
                    <el-row :gutter="20" :span="24">
                        <el-col :span="12">
                            <el-form-item label="角色id" prop="roleId">
                                <el-input v-model="roleMenu.roleId"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="菜单id" prop="menuId">
                                <el-input v-model="roleMenu.menuId"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20" :span="24">
                        <el-col :span="24">
                            <el-form-item :label="$t('table.remark')">
                                <el-input type="textarea" v-model="roleMenu.remark" :rows="3"/>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                roleMenuRules: {
                    ...
                    menuId: [
                        {required: true, message: this.$t("table.pleaseInput") + '菜单id'}
                    ]
                },
                selectedRows: [],
                dialogVisible: false,
        ...
        computed: {
            ...
            btnEnable() {
                return {
                    create: this.permission.roleMenu_create,
                    update: this.permission.roleMenu_update,
                    delete: this.permission.roleMenu_delete
                };
            }
        },
        created() {
        ...
        methods: {
            ...
            reloadList() {
                ...
                getRoleMenuList(this.listQuery).then(response => {
                    ...
                    this.roleMenuList = response.data.records;
            ...
            btnUpdate(row) {
                this.resetRoleMenu();
                if (row.id) {
                    this.roleMenu = deepClone(row);
                } else {
                    this.roleMenu = deepClone(this.selectedRows[0]);
                }
