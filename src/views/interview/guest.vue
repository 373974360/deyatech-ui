    ...
    <basic-container>
        <div class="deyatech-container pull-auto">
            ...
            <el-table :data="guestList" v-loading.body="listLoading" stripe border highlight-current-row
                ...
                <el-table-column align="center" label="嘉宾类型(1为主持人，2为嘉宾)" prop="type"/>
                    ...
                    <el-row :gutter="20" :span="24">
                        <el-col :span="12">
                            <el-form-item label="模型ID" prop="modelId">
                                <el-input v-model="guest.modelId"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                    ...
                    <el-row :gutter="20" :span="24">
                        <el-col :span="12">
                            <el-form-item label="照片" prop="photo">
                                <el-input v-model="guest.photo"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="职务" prop="job">
                                <el-input v-model="guest.job"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20" :span="24">
                        <el-col :span="12">
                            <el-form-item label="嘉宾类型(1为主持人，2为嘉宾)" prop="type">
                                <el-input v-model="guest.type"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20" :span="24">
                        <el-col :span="24">
                            <el-form-item :label="$t('table.remark')">
                                <el-input type="textarea" v-model="guest.remark" :rows="3"/>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
    ...
    export default {
        ...
        data() {
            return {
                ...
                guestRules: {
                    modelId: [
                        {required: true, message: this.$t("table.pleaseInput") + '模型ID'}
                    ],
                    name: [
                        {required: true, message: this.$t("table.pleaseInput") + '姓名'}
                    ],
                    photo: [
                        {required: true, message: this.$t("table.pleaseInput") + '照片'}
                    ],
                    job: [
                        {required: true, message: this.$t("table.pleaseInput") + '职务'}
                    ],
                    type: [
                        {required: true, message: this.$t("table.pleaseInput") + '嘉宾类型(1为主持人，2为嘉宾)'}
                    ]
                },
                selectedRows: [],
                dialogVisible: false,
