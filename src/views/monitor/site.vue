        ...
        <div class="deyatech-container pull-auto">
            <div class="deyatech-menu">
                <div class="deyatech-menu_left">
                    ...
                    <el-input :size="searchSize" placeholder="关键字" v-model.trim="listQuery.siteName" maxlength="100" style="width: 300px;margin-left: 10px;margin-right:10px;"></el-input>
                    ...
                    <el-row :gutter="20" :span="24">
                        <el-col :span="12">
                            <el-form-item label="站点名称" prop="siteName">
                                <el-input v-model.trim="site.siteName" maxlength="100"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="监测地址" prop="siteDomain">
                                <el-input v-model.trim="site.siteDomain" maxlength="100"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20" :span="24">
                        <el-col :span="24">
                            <el-form-item :label="$t('table.remark')">
                                <el-input type="textarea" v-model.trim="site.remark" :rows="3" maxlength="500"/>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            btnEnable() {
                return {
                    create: this.permission.monitor_site_create,
                    update: this.permission.monitor_site_update,
                    delete: this.permission.monitor_site_delete,
