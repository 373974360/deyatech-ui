...
const common = {
    ...
    state: {
        ...
        materialDownloadUrl: '/manage/cms/download',        // 站点文件下载,参数: siteId, url 相对路径,    例/upload/123.txt
        ...
        materialShowImageByUrl: '/manage/cms/showImage',        // 站点图片显示,参数: siteId, url 相对路径,     例/upload/123.txt
