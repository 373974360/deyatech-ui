  ...
  init: function () {
    ...
    $(document).ready(function () {
      ...
      document.body.oncontextmenu = function (event) {
        if (event.srcElement.tagName == 'shape' || event.srcElement.tagName == 'DIV' && event.srcElement.parentElement.className == 'diagram') {
          // IE DIAGRAM CANVAS OR SHAPE DETECTED!
          return false
        }
        return (!Object.isSVGElement(event.srcElement))
      }
    })
  },
